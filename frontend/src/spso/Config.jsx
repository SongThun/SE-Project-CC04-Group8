                  ...
                  {isEditing === cf.name ? (
                    <div className="items-center">
                      <button
                        ...
                        className="bg-blue-100 text-blue-500 px-4 py-1 rounded mr-2"
                      >
                        Lưu thay đổi
                      </button>
                      <button
                        onClick={handleCancel}
                        className="bg-red-100 text-red-500 px-4 py-1 rounded"
                      >
                        Hủy
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="hover:bg-blue-100 hover:text-blue-500 px-4 py-1 rounded"
                    >
                      Chỉnh sửa
                    </button>
                  )}
